...
describe('sorted_set', function() {
  ...
  it('makeSortedNumberSet', function() {
    ...
    assert.deepEqual(makeSortedNumberSet(explode_array([])).getNumbers(1, 10),
        explode_array([]));
    assert.deepEqual(makeSortedNumberSet(explode_array([1])).getNumbers(1, 10),
        explode_array([1]));
    assert.deepEqual(makeSortedNumberSet(explode_array([1, 2, 3])).getNumbers(1, 10),
        explode_array([1, 2, 3]));
    assert.deepEqual(makeSortedNumberSet(explode_array([3, 2, 1])).getNumbers(1, 10),
        explode_array([1, 2, 3]));
    assert.deepEqual(makeSortedNumberSet(explode_array([1, 1, 2, 2, 3, 3])).getNumbers(1, 10),
        explode_array([1, 2, 3]));
    assert.deepEqual(
        makeSortedNumberSet(explode_array([1, 2, 2, 49, 50, 50, 99, 100])).getNumbers(1, 10),
